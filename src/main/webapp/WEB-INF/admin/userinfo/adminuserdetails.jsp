<%@page import="admin.userdetails.dto.Member"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="../layout/header.jsp" %>

<%	List<Member> userinfo = (List) request.getAttribute("userinfoList"); %>

<div style="margin-left:480px;">
	<h1 style="margin: 30px 0;">회원 정보 조회 페이지</h1>
</div>
...
<form action="/homett/aduserdetails" method="POST">
...
<div>
	...
	<%	for(int i=0; i<userinfo.size(); i++) { %>
		<tr>
			...
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getUserNo() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >이름</th>
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getUserName() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >아이디</th>
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getUserId() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >닉네임</th>
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getUserNick() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >회원권한</th>
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getMasterNo() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >이메일</th>
			<td style="width: 200px; border-left: 0;"><%=userinfo.get(i).getUserEmail() %></td>
		</tr>
		<tr>
			<th class="text-center" style="width: 100px; height: 50px; border-right: 0;" >휴대폰번호</th>
			<td style="width: 200px; border-left: 0;;">0<%=userinfo.get(i).getUserPhone() %></td>
		</tr>
		<tr>
