...
public class Party {
	...
	public Party(int partyNo, int userNo, int partyRoomNo, String partyKind, String partyRule, int paymentAmount,
			Date partyPeriod, int partyMember, int boardCano, Date partyCreDate, Date partyEndDate, String partyName,
			String partyLeader, String ottId, String ottPw, String partyNotice) {
		super();
	...
	public String toString() {
		return "Party [partyNo=" + partyNo + ", userNo=" + userNo + ", partyRoomNo=" + partyRoomNo + ", partyKind="
				...
				+ partyLeader + ", ottId=" + ottId + ", ottPw=" + ottPw + ", partyNotice=" + partyNotice + "]";
	}
