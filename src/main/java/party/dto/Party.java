...
public class Party {
	...
	public String toString() {
		return "Party [partyNo=" + partyNo + ", partyRoomNo=" + partyRoomNo + ", userNo=" + userNo + ", partyKind="
	...
	public Party(int partyNo, int partyRoomNo, int userNo, String partyKind, String partyRule, int paymentAmount,
